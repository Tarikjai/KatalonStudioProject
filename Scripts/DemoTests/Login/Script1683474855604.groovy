...
WebUI.click(findTestObject('Object Repository/Page_Your store. Login/html_Your store. Login        window.dataLa_1ca955'))

WebUI.setText(findTestObject('Object Repository/Page_Your store. Login/input_Email_Email'), username)

WebUI.setText(findTestObject('Object Repository/Page_Your store. Login/input_Password_Password'), password)
